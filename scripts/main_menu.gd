...
const CHANGELOG_ENTRIES := [
	...
	["v0.6.2", ["opening a menu takes the worlds labels down with it.",
	...
	["v0.6.1", ["the power lines actually connect tower to tower now.",
	...
	["v0.6.0", ["the grid runs across the district: lattice towers with",
	...
	["v0.5.14", ["dying ends the raid now. three rounds and you get the",
	...
	["v0.5.13", ["walking out of a raid is not free any more. the pause",
		...
		"eyes, arms, legs"]],
	["v0.5.12", ["every place has its own things in it now. benches,",
	...
	["v0.5.11", ["freight moved to where freight belongs: the crates and",
	...
	["v0.5.10", ["rain and storms are actually different weather now. a",
	...
	["v0.5.9", ["the clock and the light agree now: dawn at 06:00, dusk",
	...
	["v0.5.8", ["the map select screen shows the districts clock and",
		...
		"the menu"]],
	["v0.5.7", ["the freight keeps a timetable now: she comes at 24:00,",
	...
	["v0.5.6", ["houses have lights inside now. they come on with the",
	...
	["v0.5.5", ["pines shed now. they drop needles, not leaves - a",
		...
		"purpose"]],
	["v0.5.4", ["transit is not laid out on graph paper any more.",
	...
	["v0.5.3", ["the stutter on first opening the changelog and the",
	...
	["v0.5.2", ["the yellow centre line finally runs down the middle",
	...
	["v0.4.12", ["housekeeping: the audits verified a pile of code that",
	...
	["v0.4.11", ["the sweep, part two - fifteen more, none silent:",
	...
	["v0.4.10", ["a code sweep found some bad ones:",
	...
	["v0.4.9", ["loading into transit had a 233ms stall in it. it was a",
		"developer contact sheet - half a megabyte of artwork the",
		"game never shows - being loaded every single raid"]],
	["v0.4.8", ["the snipers stop shooting once youre riding the freight",
	...
	["v0.4.4", ["the district is bigger: every block has more room, and",
	...
	["v0.4.2", ["the scrapyard warehouse is back. fixing the track",
	...
	["v0.4.1", ["the railway stopped looking like a drawn line:",
	...
	["v0.4.0", ["the night freight runs. it comes into the yard every",
	...
	["v0.3.14", ["leaves fall from every leafy tree now, and they take",
	...
	["v0.3.13", ["the toll gate: a warden in a booth on the south road,",
	...
	["v0.3.12", ["clutter looks dumped now, not placed: crates, tires,",
	...
	["v0.3.11", ["you can only interact with what the prompt is",
	...
	["v0.3.10", ["you can get out now. the first way out is the lift:",
	...
	["v0.3.9", ["the map is drawn now, not screenshotted: roads are",
	...
	["v0.3.8", ["windows behave now: whatever you have open owns the",
	...
	["v0.3.7", ["cars point where theyre going - eight real angles now,",
	...
	["v0.3.6", ["the map is real now: press m for the whole district,",
	...
	["v0.3.5", ["the district is fixed now - one map, the same streets",
	...
	["v0.3.4", ["the bushes grew up - big enough to disappear into",
	...
	["v0.3.3", ["you spawn in the safehouse now - same squat house every raid,",
	...
	["v0.3.2", ["press m: the map. world view first, then transit in detail",
	...
	["v0.3.1", ["the map got way smaller again - and it has real places now",
	...
	["v0.3.0", ["morning fog: mist banks drift through the woods and roads at dawn",
	...
	["v0.2.14", ["raid music: your three picks rotate randomly, never twice in a row",
	...
	["v0.2.13", ["three new living menu backdrops: the den, the drain, the storm",
	...
	["v0.2.12", ["the map is half the size - a tight district, no more hiking",
	...
	["v0.2.11", ["cars and trucks have real backs now - you circled it, that was it",
	...
	["v0.2.10", ["car look rolled back to the original dark ends (your call)",
		"kept: the ramp fills, smaller wheel arches, attached door"]],
	["v0.2.9", ["everything is 3d now: pillars are real columns with caps",
	...
	["v0.2.8", ["car ends are visible now - they existed but were painted too dark",
	...
	["v0.2.7", ["the missing car parts are ACTUALLY fixed (raked windshields had gaps)",
	...
	["v0.2.6", ["the sapphire signal splash: the gem, the ping, the first beam",
	...
	["v0.2.5", ["the barricade line is a real line now: one piece repeated, worn",
	...
	["v0.2.4", ["go prone on z: flat on your stomach, crawling",
	...
	["v0.2.3", ["the playable map is smaller - barricades mark the real edge now",
	...
	["v0.2.2", ["fixed the blurry walk: character and camera share one pixel grid now",
		"diagonal walking no longer shimmers the world",
		"the character is pixel-locked to the screen while moving"]],
	["v0.2.1", ["the map is 4x bigger again - and it has a name: transit",
	...
	["v0.2.0", ["the map is 10x bigger - a whole district, and it never ends",
	...
	["v0.1.14", ["loading yard by the warehouse: stall lines, pickup trucks",
	...
	["v0.1.13", ["keybinds screen in settings: rebind every key",
	...
	["v0.1.12", ["all walls and corners symmetrical again",
